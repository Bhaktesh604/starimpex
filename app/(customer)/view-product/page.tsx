...
function Page() {
  ...
  useEffect(() => {
    if (!isGetDiamondLoading && getDiamondResponse) {
      ...
      if (getDiamondResponse.responseCode === ResponseCodes.NOT_FOUND) {
        router.replace(links.DATA_NOT_FOUND);
      }
      setIsLoading(false);
    }
  }, [isGetDiamondLoading, getDiamondResponse, router]);
  ...
  const addItemToCart = async () => {
    ...
    addToCartRequest(router, [diamond._id]);
  };

  return (
    <div className="z-[4] w-full mt-[9rem] md:mt-[6rem]">
      <div className="mb-[2rem] px-[2rem]">
        <div className="bg-secondary rounded-lg pb-5">
          <div className="px-[1.5rem] py-[0.8rem] flex justify-between items-center">
            ...
            <div>
              <button
                className="bg-tertiary py-3 px-4 rounded-xl text-secondary font-semibold text-sm transition-transform hover:-translate-y-1 hover:scale-105 duration-500"
          ...
          <div className="ml-[2rem] mr-[2rem] lg:mr-[6rem]">
            <div className="py-[1rem] grid grid-cols-1 lg:grid-cols-[30%_50%_20%] gap-8 h-full ">
              <div>
                ...
                <div className="z-[1]">
                  <div className="pt-[0.5rem] grid grid-cols-2 border-x border-b-[1px] border-x-solid border-b-solid border-x-[#BDBDBD] border-b-[#BDBDBD]">
                    <div className="pl-4 py-[0.4rem] bg-tertiary bg-opacity-[7%]">
                      <p className="font-semibold text-primary">Stone No</p>
                    </div>
                    <div className="pl-4 py-[0.4rem] border-l-[1px] border-solid border-[#BDBDBD]">
                  ...
                  <div className="grid grid-cols-2 border-x border-b-[1px] border-x-solid border-b-solid border-x-[#BDBDBD] border-b-[#BDBDBD]">
                    <div className="pl-4 py-[0.4rem] bg-tertiary bg-opacity-[7%]">
                  ...
                  <div className="grid grid-cols-2 border-x border-b-[1px] border-x-solid  rounded-b-xl border-b-solid border-x-[#BDBDBD] border-b-[#BDBDBD]">
                    <div className="pl-4 py-[0.4rem] bg-tertiary bg-opacity-[7%]">
