...
function DiamondsGridView({
  ...
  return (
    <div>
      <div key={diamond._id}>
        <div className="rounded-lg border-[1px] w-full">
          <div className="relative">
            <div className="imageContainer relative aspect-square h-auto">
              ...
              <input
                type="checkbox"
                className="accent-tertiary w-4 h-4 rounded-md cursor-pointer absolute top-2 right-2"
                checked={isChecked}
                onChange={(e) => onSelect(e, diamond)}
              />
            </div>
          </div>
          <div className="grid grid-cols-3 place-items-start py-2 px-4">
            <p
          ...
          <Link
            ...
            prefetch={false}
          >
            <div className="bg-tertiary flex justify-center items-center rounded-b-[0.625rem]">
