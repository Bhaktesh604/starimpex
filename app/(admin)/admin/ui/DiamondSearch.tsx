...
const DiamondSearch = () => {
  ...
  const setFilters = useCallback(() => {
    ...
    const is_fancy_clor = searchParams.get(diamondQueryParams.IS_FANCY_COLOR);
    ...
    if (is_fancy_clor) {
      const fancyValue = isFancyColor;
      setIsFancyColor(fancyValue);
    }
    if (shape) {
  ...
  const onDiamondTypeChangeHandler = (type: EDiamondType) => {
    router.push(
      `${links.ADMIN_ADVANCE_SEARCH}?${diamondQueryParams.DIAMOND_TYPE}=${type}`
    );
  ...
  const handleFormSubmit = (e: any) => {
    ...
    let searchLink = `${links.ADMIN_SEARCH_RESULT}?${diamondQueryParams.DIAMOND_TYPE}=${diamondType}`;
    if (isNoBGM === true) {
  ...
  return (
    <section>
      <div className="container">
        <div className="flex flex-row items-center justify-center gap-x-6 py-6 flex-wrap max-sm:gap-y-3">
          <ButtonComponent
        ...
        <form className="bg-white rounded-3 pb-14" onSubmit={handleFormSubmit}>
          <div className="max-w-full ">
            <div className="max-w-full w-full grid grid-cols-2">
              <div className="border-r-[1px] border-primary/20 max-[48rem]:col-span-2 max-[48rem]:border-r-0 max-[48rem]:border-b-[1px]">
                      ...
                      >
                        <div className="flex flex-col cursor-pointer relative">
                          ...
                          <div
                            ...
                            } mb-[0.313rem] rounded-[0.625rem] p-[0.625rem] `}
                          >
                          ...
                          <label
                            ...
                            className="text-xs capitalize text-center peer-checked/shape:font-medium"
                          >
                            {shape.name}
                          </label>
                        </div>
              ...
              <div className="max-[48rem]:col-span-2 max-[48rem]:border-b-[1px] border-primary/20">
                <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                  Lab
                </span>
                <ul
                          ...
                          <li key={`diamond-lab-options-${index}`}>
                            <div className="flex flex-col cursor-pointer relative">
                              ...
                              <label
                                ...
                                className="text-xs uppercase text-center peer-checked/lab:font-medium"
                              >
                                {lab.name}
                              </label>
                            </div>
            ...
            <div className="max-w-full w-full grid grid-cols-2">
              <div className="border-r-[1px] border-primary/20 max-[48rem]:col-span-2 max-[48rem]:border-r-0 max-[48rem]:border-b-[1px]">
                <div className="border-b-[1px] border-primary/20 max-md:overflow-hidden">
                  <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                    Carat
                  </span>
                  <div className="max-md:overflow-y-auto">
                            ...
                            <button
                              className={`${
                                isTypeNatural
                                  ? "bg-tertiary"
                                  : "bg-tertiary-alt"
                              } rounded-[0.313rem] flex justify-center items-center p-[0.625rem] w-8 h-8`}
                              type="button"
                            ...
                            <button
                              className={`${
                                isTypeNatural
                                  ? "bg-tertiary"
                                  : "bg-tertiary-alt"
                              } rounded-[0.313rem] flex justify-center items-center p-[0.625rem]`}
                              type="button"
                    ...
                    {diamondClarity.map((clarity: any, index: any) => {
                      return (
                        ...
                        >
                          ...
                          />
                          <label
                            className={`py-2 px-4 rounded-md text-xs uppercase ${
                              isTypeNatural
                        ...
                        return (
                          <li key={`diamond-fluorescence-options-${index}`}>
                            <div className="relative">
                              ...
                              />
                              <p
                                className={`py-[0.625rem] w-max px-4 ${
                                  isTypeNatural
                                ...
                                } rounded-md uppercase text-xs peer-checked/fluorescence:font-medium`}
                              >
                                {fluorescence.name}
                              </p>
                            </div>
                ...
                <div className="grid grid-cols-2 border-t-[1px] border-primary/20">
                  <div className="lg:border-r-[1px] max-[48rem]:border-r-[1px] md:border-r-[1px] border-primary/20   lg:col-span-1 max-[48rem]:col-span-1 max-md:col-span-2 max-md:border-r-0 max-md:border-b-[1px]">
                    <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                      Location
                    </span>
                  ...
                  <div className="lg:col-span-1 max-[48rem]:col-span-1 max-md:col-span-2">
                    <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                      Eye Clean
                    </span>
                    <div className="pt-8 pb-4 px-5">
              ...
              <div className="max-[48rem]:col-span-2">
                <div className="border-b-[1px] border-primary/20">
                  <div className="advance-search-label border-b border-primary/40 flex flex-wrap max-[40rem]:gap-y-1 flex-row justify-start items-center">
                    <span className="max-w-full flex flex-col md:mr-9 sm:mr-4 mr-3 ">
                      Color
                    </span>
                  ...
                  >
                    ...
                    <div className="px-2 grid gap-2">
                      <label className="text-sm">Overtone</label>
                      <Select
                        isMulti
                        name="overtone"
                        closeMenuOnSelect={false}
                    ...
                    {diamondColorList.map((color: any, index: any) => {
                      return (
                        <li key={`diamond-color-options-${index}`}>
                          <div className="w-[3.75rem] relative">
                            <input
                              type="checkbox"
                ...
                <div className="border-b-[1px] border-primary/20">
                  <div className="advance-search-label border-b border-primary/40 flex flex-wrap max-[40rem]:gap-y-1 flex-row justify-start items-center py-3">
                    <span className="max-w-full flex flex-col md:mr-9 sm:mr-4 mr-3">
                      Cut
                    </span>
                    <div className="font-normal text-xs leading-4 flex flex-row justify-center mr-4">
                      <input
                        type="checkbox"
                        id="checkbox-id-ex"
                        ...
                        <li key={`diamond-cut-options-${index}`}>
                          <div className="relative">
                            ...
                            <p
                              ...
                              } rounded-md uppercase text-xs peer-checked/cut:font-medium`}
                            >
                              {cut.code}
                            </p>
                          </div>
                ...
                <div className="border-b-[1px] border-primary/20">
                  <div className="advance-search-label border-b border-primary/40 flex flex-row justify-start items-center pt-2 pb-[0.313rem]">
                        ...
                        <li key={`diamond-polish-options-${index}`}>
                          <div className="relative">
                            ...
                            <p
                              ...
                              } rounded-md uppercase text-xs peer-checked/polish:font-medium`}
                            >
                              {polish.code}
                            </p>
                          </div>
                        ...
                        <li key={`diamond-symmetry-options-${index}`}>
                          <div className="relative">
                            ...
                            <p
                              ...
                              } rounded-md uppercase text-xs peer-checked/symmetry:font-medium`}
                            >
                              {symmetry.code}
                            </p>
                          </div>
          ...
          <div className="grid grid-cols-4 border-t-[1px] border-b-[1px] border-primary/20">
            <div className="border-r-[1px] max-md:border-b-[1px] md:border-b-[1px] lg:border-b-0 border-primary/20 sm:col-span-2 md:col-span-2 lg:col-span-1 max-md:col-span-2 max-[32.813rem]:col-span-4 max-[32.813rem]:border-r-0">
              <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                Disc % Range
              </span>
            ...
            <div className=" lg:border-r-[1px] max-md:border-b-[1px] md:border-b-[1px] lg:border-b-0 md:border-r-0 border-primary/20 sm:col-span-2 md:col-span-2 lg:col-span-1 max-md:col-span-2 max-[32.813rem]:col-span-4">
              <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
            ...
            <div className="border-r-[1px]  border-primary/20 sm:col-span-2 md:col-span-2 lg:col-span-1 max-md:col-span-2 max-[32.813rem]:col-span-4 max-[32.813rem]:border-r-0">
              <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                Total Price Range $
              </span>
              <div className="pt-8 pb-4 px-5 flex flex-row gap-4">
            ...
            {diamondType === EDiamondType.LAB_GROWN_DIAMONDS ? (
              <div className="border-primary/20  sm:col-span-2 md:col-span-2 lg:col-span-1 max-[40rem]:col-span-2 max-[32.813rem]:col-span-4">
                <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                  Type
                </span>
                <div className="pt-8 pb-4 px-5 flex flex-row gap-4">
                          ...
                          <li key={`lab-grown-type-options-${index}`}>
                            <div className="relative">
                              ...
                              <p
                                ...
                                } rounded-md uppercase text-xs peer-checked/lab-grown-type:font-medium`}
                              >
                                {type.replace("_")}
                              </p>
                            </div>
          ...
          <div className="max-w-full w-full py-[42px]">
            <div
              ...
              } flex flex-row justify-between items-center rounded-xl max-w-full w-full py-3 px-8 font-semibold text-lg leading-5 text-white max-[48rem]:py-3 max-[48rem]:px-5 max-[48rem]:font-medium max-[48rem]:text-base max-[48rem]:leading-4`}
            >
            ...
            >
              <div className="grid lg:grid-cols-4 border-b-[1px] border-primary/20 md:grid-cols-2 ">
                <div className="pl-[1.125rem] pr-6 border-r-[1px] border-primary/20 pt-2">
                  <div>
                    <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                      Table%
                    </span>
                ...
                <div className="pl-[1.125rem] pr-6 pt-2">
                  <div>
                    <span className="advance-search-label border-b border-primary/40 max-w-full w-full flex flex-col">
                      Width
                    </span>
